...
class LimeAudioClip implements funkin.vis.AudioClip
{
	...
	public var manualTime:Bool = false;
	...
	private function get_currentFrame():Int
	{
		...
		var _time = manualTime ? time : audioSource.currentTime;
		var value = Std.int(FlxMath.remapToRange(_time, 0, audioSource.length, 0, dataLength));
