...
typedef SaveFile = {
    ...
    #if !android
        var controls:Array<{c:String, keys:Array<FlxKey>}>; //useless on android.
    #end
...
class Save {
    ...
    public static function readSaveFile(file:String):SaveFile {
        ...
        return {
            ...
            #if !android controls: Main.saveFile.data.controls??([]:Array<{c:String,keys:Array<FlxKey>}>), #end
