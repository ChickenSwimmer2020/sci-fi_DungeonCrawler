...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("[NAME]", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("[NAME]", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "[NAME]";
		app.meta["name"] = "[INSERT NAME HERE]";
		...
		#elseif air
		app.window.title = "[INSERT NAME HERE]";
		#else
